...
// // if user is logged in, then take user to account page
...
//     $stmt = $conn->prepare("SELECT user_id, name, email, password FROM users WHERE email = ? AND password = ? LIMIT 1");
...
//     }else{
//         header('location: login.php?error=no account with these credentials');
//     }
// }
